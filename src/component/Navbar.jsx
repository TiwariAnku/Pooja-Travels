    ...
    <nav className={`fixed top-0 w-full z-50 transition-all duration-500 ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 relative flex items-center justify-between">
        ...
        <Link to="/" className="flex items-center gap-3 group cursor-pointer shrink-0">
          ...
          <div className="w-12 h-12 rounded-full border-2 border-[#d4af37] p-0.5 bg-white flex items-center justify-center shadow-md transition-transform duration-300 group-hover:scale-105 overflow-hidden">
            <img 
              src={logoImg}
              alt="Pooja Travels" 
          ...
          <div className="flex flex-col leading-none">
            ...
            <span className="text-[9px] sm:text-[10px] font-bold tracking-[0.3em] uppercase text-amber-500/80 mt-1">
              Est. 2008
            </span>
          </div>
        </Link>
