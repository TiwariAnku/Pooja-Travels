...
<head>
  ...
  <style>
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    .wrapper { max-width:660px; margin:30px auto; background:#fff;
    ...
    .footer { background: linear-gradient(135deg, #1a237e, #283593);
              padding:24px 30px; text-align:center; }
    .footer .co-name { color:#fff; font-size:16px; font-weight:bold;
                       letter-spacing:1px; margin-bottom:8px; }
    .footer p { color:#9fa8da; font-size:12px; line-height:1.8; }
    .footer .divider { border:none; border-top:1px solid #3949ab;
                       margin:12px auto; width:60%; }
...
<div class="wrapper">
  ...
  <div class="table-wrap">
    <table>
      ...
      <tbody>
        ...
        <tr><td>6</td>  <td>Date of Drop</td>            <td>${data.dropDate}</td></tr>
        <tr><td>7</td>  <td>Car Type</td>                <td>${data.carType}</td></tr>
        <tr><td>8</td>  <td>Remarks</td>                 <td>${data.remarks || 'N/A'}</td></tr>
      </tbody>
    </table>
  </div>
  ...
  <div class="status-wrap">
    ...
    <p style="margin-top:14px; color:#666; font-size:13px;">
      For any changes or queries, please contact us immediately.
    </p>
  </div>
  ...
  <style>
    * { margin:0; padding:0; box-sizing:border-box; }
    ...
    .wrapper { max-width:660px; margin:30px auto; background:#fff;
               border-radius:10px; overflow:hidden;
               box-shadow:0 4px 16px rgba(0,0,0,0.12); }
    .header { background: linear-gradient(135deg, #e65100, #bf360c);
              padding:30px; text-align:center; }
    ...
    .footer { background: linear-gradient(135deg, #e65100, #bf360c);
              padding:24px 30px; text-align:center; }
    ...
    .footer .divider { border:none; border-top:1px solid #ff7043;
                       margin:12px auto; width:60%; }
  ...
  <div class="body">
    ...
    <table>
      ...
      <tbody>
        ...
        <tr><td>Drop Date</td>              <td>${data.dropDate}</td></tr>
